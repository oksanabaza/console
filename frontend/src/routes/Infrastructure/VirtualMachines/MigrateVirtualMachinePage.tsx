    ...
    >
      ...
      >
        <Step id="target" label={t('Target placement')}>
          <WizTextInput path="spec.provider.source.name" label="Cluster" disabled />
          <WizTextInput path="spec.provider.source.namespace" label="Project" disabled />
          <WizTextInput path="spec.provider.destination.name" label={t('Cluster')} required />
          <WizTextInput path="spec.provider.destination.namespace" label={t('Project')} required />
        </Step>
